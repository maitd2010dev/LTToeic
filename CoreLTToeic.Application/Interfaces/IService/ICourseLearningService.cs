...
namespace CoreLTToeic.Application.Interfaces.IService
{
    public interface ICourseLearningService
    {
        ...
        Task<CourseDetailViewModel?> GetCourseDetailsAsync(long courseId, string? userId);
        Task<CourseDetailViewModel?> GetLearningCourseAsync(long courseId, string userId);
